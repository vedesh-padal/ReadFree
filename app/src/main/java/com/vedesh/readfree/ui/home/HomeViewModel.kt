...
class HomeViewModel(
    ...
    val articles: StateFlow<List<ArticleWithTags>> = combine(_filterState, _searchQuery) { filter, query ->
        filter to query
    ...
    fun setFilter(type: FilterType, listId: Long? = null, tag: String? = null) {
